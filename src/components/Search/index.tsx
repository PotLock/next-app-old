...
const Search = () => {
  ...
  return (
    <div className="relative mx-4 sm:mx-0">
        ...
        <input type="search" className="block w-full p-4 ps-12 text-sm text-gray-900 rounded-sm bg-[#F0F0F0]  focus:outline-none " placeholder="Search (9) projects..." />  
        <Dropdown>
        ...
        {(item) => (
          ...
          >
            ...
            className='flex  items-center justify-between text-sm '>
              ...
              {
              item.label === filter ? <IconCheck/> : <div className='w-[12px]'></div>
              }
            {item.label}
              </div>
